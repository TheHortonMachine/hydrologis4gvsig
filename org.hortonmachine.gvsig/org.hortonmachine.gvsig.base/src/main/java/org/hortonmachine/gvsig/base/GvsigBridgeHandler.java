...
public class GvsigBridgeHandler implements GuiBridgeHandler {
    ...
    public File getLibsFolder() {
        File hmLibsFolder = ProjectUtilities.getFileInPlugin(HortonMachineExtension.class, "lib");
        return hmLibsFolder;
    }
    ...
    public HashMap<String, String> getSpatialToolboxPreferencesMap() {
        DynObject preferences = ProjectUtilities.getPluginPreferences(HortonMachineExtension.class);
    ...
    public String promptForCrs() {
        IProjection projection = HMUtilities.openCrsDialog();
        if (projection != null) {
