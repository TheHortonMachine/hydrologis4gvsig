    ...
    private void init() {
        ...
        copyLatButton.addActionListener(new ActionListener(){
            public void actionPerformed( ActionEvent e ) {
                HMUtilities.copyToClipboard(latTextField.getText());
            }
        });
        ...
        copyLonButton.addActionListener(new ActionListener(){
            public void actionPerformed( ActionEvent e ) {
                HMUtilities.copyToClipboard(lonTextField.getText());
            }
        });
        ...
        copyYButton.addActionListener(new ActionListener(){
            public void actionPerformed( ActionEvent e ) {
                HMUtilities.copyToClipboard(yField.getText());
            }
        });
        ...
        copyXButton.addActionListener(new ActionListener(){
            public void actionPerformed( ActionEvent e ) {
                HMUtilities.copyToClipboard(xField.getText());
            }
        });
