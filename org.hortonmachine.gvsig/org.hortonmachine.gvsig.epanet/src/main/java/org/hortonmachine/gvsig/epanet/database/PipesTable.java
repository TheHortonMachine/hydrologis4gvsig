...
/**
 * The persistent class representing the epanet pipes table.
 * 
 * @author Andrea Antonello (www.hydrologis.com)
 */

@DatabaseTable(tableName = PIPES)
public class PipesTable implements IWork {
