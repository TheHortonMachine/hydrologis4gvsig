...
/**
 * The persistent class representing the epanet reservoirs table.
 * 
 * @author Andrea Antonello (www.hydrologis.com)
 */
@DatabaseTable(tableName = RESERVOIRS)
public class ReservoirsTable implements IWork {
