...
//                // inputData.guiHints.equals(JGTConstants.FILESPATHLIST_UI_HINT)) {
...
//        if (guiHints != null) {
//            if (guiHints.contains(SpatialToolboxConstants.FILEOUT_UI_HINT)
//                    || guiHints.contains(SpatialToolboxConstants.FOLDEROUT_UI_HINT)) {
//                isBold = true;
//            }
//        }
