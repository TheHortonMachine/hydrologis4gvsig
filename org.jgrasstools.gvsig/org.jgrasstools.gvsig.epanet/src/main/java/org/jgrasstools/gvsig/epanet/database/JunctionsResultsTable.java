...
/**
 * The persistent class representing the epanet junctions result table.
 * 
 * @author Andrea Antonello (www.hydrologis.com)
 */
@DatabaseTable(tableName = JUNCTIONSRESULT)
public class JunctionsResultsTable implements INodeResults {
     ...
     */
    @DatabaseField(foreign = true, columnName = JUNCTIONS_ID, canBeNull = false, uniqueCombo = true)
    ...
    public JunctionsTable getWork() {
        return work;
    }

    public void setWork( JunctionsTable work ) {
        this.work = work;
    }
