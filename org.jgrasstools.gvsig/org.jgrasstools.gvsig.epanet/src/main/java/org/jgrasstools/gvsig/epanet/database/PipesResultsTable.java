...
/**
 * The persistent class representing the epanet pipes result table.
 * 
 * @author Andrea Antonello (www.hydrologis.com)
 */
@DatabaseTable(tableName = PIPESRESULT)
public class PipesResultsTable implements ILinkResults {
     ...
     */
    @DatabaseField(foreign = true, columnName = PIPES_ID, canBeNull = false, uniqueCombo = true)
    ...
    public PipesTable getWork() {
        return work;
    }

    public void setWork( PipesTable work ) {
        this.work = work;
    }
