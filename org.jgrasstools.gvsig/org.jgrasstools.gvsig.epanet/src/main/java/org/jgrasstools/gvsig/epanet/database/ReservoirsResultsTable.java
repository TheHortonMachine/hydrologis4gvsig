...
/**
 * The persistent class representing the epanet reservoirs result table.
 * 
 * @author Andrea Antonello (www.hydrologis.com)
 */
@DatabaseTable(tableName = RESERVOIRSRESULT)
public class ReservoirsResultsTable implements INodeResults {
     ...
     */
    @DatabaseField(foreign = true, columnName = RESERVOIRS_ID, canBeNull = false, uniqueCombo = true)
    ...
    public ReservoirsTable getWork() {
        return work;
    }

    public void setWork( ReservoirsTable work ) {
        this.work = work;
    }
