...
/**
 * The persistent class representing the epanet pumps result table.
 * 
 * @author Andrea Antonello (www.hydrologis.com)
 */
@DatabaseTable(tableName = PUMPSRESULT)
public class PumpsResultsTable implements ILinkResults {
    ...
    public PumpsTable getWork() {
        return work;
    }

    public void setWork( PumpsTable work ) {
        this.work = work;
    }
